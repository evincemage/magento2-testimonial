<?php
namespace Evincemage\Testimonial\Model\ResourceModel;
...
class Post extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('evince_testimonial_post', 'entity_id');
    }
     ...
     * @param string $field
     * @param mixed $value
     * @param \Evincemage\Testimonial\Model\Post $object
     ...
     */
    protected function _getLoadByUrlKeySelect($url_key, $status = null)
    {
...
/*    protected function isValidPostUrlKey(\Magento\Framework\Model\AbstractModel $object)
    ...
    public function checkUrlKey($url_key)
    {
        ...
        $select->reset(\Zend_Db_Select::COLUMNS)->columns('bp.entity_id')->limit(1);
